...
### Mass Spec data
```{r, warning=FALSE}
file_path_pST_Set1 <- "../Data/Mass_Spec/SH_20230329_CRC_Xenografts_Batch1_Set1_pST_F_PSMs.txt"
file_path_pST_Set1_oneshot <- "../Data/Mass_Spec/SH_20230406_CRC_Xenografts_Batch1_Set1_TMTPro_AC54_AA_pST_PSMs.txt"
file_path_pST_Set2 <- "../Data/Mass_Spec/SH_20230330_CRC_Xenografts_Batch1_Set2_pST_F_PSMs.txt"

file_path_pY_Set1 <- "../Data/Mass_Spec/SH_20230201_CRC_Xenografts_Batch1_Set1_TMTPro_AC54_AA_pY_PSMs.txt"
file_path_pY_Set2 <- "../Data/Mass_Spec/SH_20230202_CRC_Xenografts_Batch1_Set2_TMTPro_AC56_AA_pY_PSMs.txt"

file_path_sup_Set1 <- "../Data/Mass_Spec/SH_20230201_CRC_Xenografts_Batch1_Set1_TMTpro_pre9+AC52_HR1_sup_PSMs.txt"
file_path_sup_Set2 <- "../Data/Mass_Spec/SH_20230202_CRC_Xenografts_Batch1_Set2_TMTpro_pre10+AC53_HR1_sup_PSMs.txt"
...
pY_Set1 <- Filter_And_Average_PSMs(file_path_phos = file_path_pY_Set1,  
                              ...
                              #norm_channel = "128C") %>%
                              norm_channel = c("128N", "128C", "130N","133C" ) ) %>%
...
pY_Set2 <- Filter_And_Average_PSMs(file_path_phos = file_path_pY_Set2, 
                              ...
                              NA_cutoff_channel = 0.4,
                              #norm_channel = "132N") %>%
                              norm_channel = c("127N", "128N", "130C","132N" ) ) %>%
    filter(grepl("y", `Annotated Sequence` ) )
```
...
pY_Set1_withNA_norm <- Norm_To_ctrl(pY_Set1_withNA_norm, norm_channel = "128C")
...
pY_Set2_withNA_norm <- Norm_To_ctrl(pY_Set2_withNA_norm, norm_channel = "132N")
...
# Set 1 One Shot
pST_Set1_oneshot <- Filter_And_Average_PSMs(file_path_phos = file_path_pST_Set1_oneshot,  
                              file_path_sup = file_path_sup_Set1,
                              return_data = "phos", 
                              NA_replace = FALSE, NA_peptide_cutoff = 0,
                              ion_score_filter = 20, 
...
sup_Set1 <- Filter_And_Average_PSMs(file_path_phos = file_path_pST_Set1,  
                              file_path_sup = file_path_sup_Set1,
                              return_data = "sup", 
                              NA_replace = FALSE, NA_peptide_cutoff = 0,
                              ion_score_filter = 20)
...
pST_Set1_withNA_norm <- Norm_To_ctrl(pST_Set1_withNA_norm, norm_channel = "128C")
...
sup_Set2 <- Filter_And_Average_PSMs(file_path_phos = file_path_pST_Set2,  
                              file_path_sup = file_path_sup_Set2,
                              return_data = "sup", 
                              NA_replace = FALSE, NA_peptide_cutoff = 0,
                              ion_score_filter = 20)
...
pST_Set2_withNA_norm <- Norm_To_ctrl(pST_Set2_withNA_norm, norm_channel = "132N")
...
#### Samples
```{r}
name_l_Set1 = list( "126" = "Xenograft_EC_24h_2_Set1", 
               "127N" = "Xenograft_EC_24h_5_Set1", 
               "127C" = "Xenograft_E_24h_4_Set1", 
               "128N"	= "Xenograft_ctrl_5d_7_Set1", 
               "128C"	 = "Xenograft_ctrl_5d_1_Set1", # this one
               "129N"	= "Xenograft_EC_24h_1_Set1", 
               "129C"	= "Xenograft_EBC_24h_3_Set1", 
               "130N"	= "Xenograft_ctrl_5d_3_Set1", 
               "130C"	= "Xenograft_E_24h_1_Set1", 
               "131N"	= "Xenograft_E_24h_2_Set1", 
               "131C"	= "Xenograft_EBC_24h_2_Set1", 
               "132N"	= "Xenograft_EBC_24h_4_Set1", 
               "132C"	= "Xenograft_E_24h_5_Set1", 
               "133N"	= "Xenograft_E_24h_3_Set1", 
               "133C"	= "Xenograft_ctrl_5d_5_Set1", 
               "134N"= "Xenograft_EC_24h_4_Set1", 
               "134C"	= "Xenograft_EC_24h_3_Set1", 
               "135N"	= "Xenograft_EBC_24h_1_Set1"
)

name_l_Set2 = list( "126" = "Xenograft_EBC_5d_4_Set2", 
               "127N" = "Xenograft_ctrl_5d_7_Set2", 
               "127C" = "Xenograft_EC_5d_3_Set2", 
               "128N"	= "Xenograft_ctrl_5d_5_Set2", 
               "128C"	 = "Xenograft_E_5d_2_Set2", 
               "129N"	= "Xenograft_EBC_5d_3_Set2", 
               "129C"	= "Xenograft_E_5d_3_Set2", 
               "130N"	= "Xenograft_EBC_5d_2_Set2", 
               "130C"	= "Xenograft_ctrl_5d_3_Set2", 
               "131N"	= "Xenograft_E_5d_4_Set2", 
               "131C"	= "Xenograft_EC_5d_4_Set2", 
               "132N"	= "Xenograft_ctrl_5d_1_Set2", # this one
               "132C"	= "Xenograft_E_5d_5_Set2", 
               "133N"	= "Xenograft_EC_5d_2_Set2", 
               "133C"	= "Xenograft_EC_5d_1_Set2", 
               "134N"= "Xenograft_EBC_5d_1_Set2", 
               "134C"	= "Xenograft_EC_5d_5_Set2", 
               "135N"	= "Xenograft_EBC_5d_5_Set2"
)
```

#### Prep
```{r}
prep_l = list(  "Xenograft_EC_24h_2_Set1" = "prep1",
                "Xenograft_EC_24h_5_Set1" = "prep1",
                "Xenograft_E_24h_4_Set1" = "prep1",
                "Xenograft_ctrl_5d_7_Set1" = "prep2",
                "Xenograft_ctrl_5d_1_Set1" = "prep1",
                "Xenograft_EC_24h_1_Set1" = "prep1",
                "Xenograft_EBC_24h_3_Set1" = "prep1",
                "Xenograft_ctrl_5d_3_Set1" = "prep1",
                "Xenograft_E_24h_1_Set1" = "prep1",
                "Xenograft_E_24h_2_Set1" = "prep1",
                "Xenograft_EBC_24h_2_Set1" = "prep1",
                "Xenograft_EBC_24h_4_Set1" = "prep1",
                "Xenograft_E_24h_5_Set1" = "prep1",
                "Xenograft_E_24h_3_Set1" = "prep1",
                "Xenograft_ctrl_5d_5_Set1" = "prep2",
               "Xenograft_EC_24h_4_Set1" = "prep1",
                "Xenograft_EC_24h_3_Set1" = "prep1",
                "Xenograft_EBC_24h_1_Set1" = "prep1",
                "Xenograft_EBC_5d_4_Set2"  = "prep2", 
                "Xenograft_ctrl_5d_7_Set2"  = "prep2", 
                "Xenograft_EC_5d_3_Set2"  = "prep2", 
                "Xenograft_ctrl_5d_5_Set2"  = "prep2", 
                "Xenograft_E_5d_2_Set2" = "prep2", 
                "Xenograft_EBC_5d_3_Set2" = "prep2", 
                "Xenograft_E_5d_3_Set2" = "prep2", 
                "Xenograft_EBC_5d_2_Set2" = "prep2", 
                "Xenograft_ctrl_5d_3_Set2"  = "prep1", 
                "Xenograft_E_5d_4_Set2" = "prep2", 
                "Xenograft_EC_5d_4_Set2"  = "prep2", 
                "Xenograft_ctrl_5d_1_Set2"  = "prep1", 
                "Xenograft_E_5d_5_Set2" = "prep2", 
                "Xenograft_EC_5d_2_Set2"  = "prep2", 
                "Xenograft_EC_5d_1_Set2"  = "prep2", 
                "Xenograft_EBC_5d_1_Set2"  = "prep2", 
                "Xenograft_EC_5d_5_Set2"  = "prep2", 
                "Xenograft_EBC_5d_5_Set2" = "prep2" 
               )
```

#### Seppack
```{r}
seppack_l = list( "Xenograft_EC_24h_2_Set1" = "seppack?",
                "Xenograft_EC_24h_5_Set1" = "seppack?",
                "Xenograft_E_24h_4_Set1"  = "seppack?",
                "Xenograft_ctrl_5d_7_Set1"  = "seppack?",
                "Xenograft_ctrl_5d_1_Set1" = "seppack?",
                "Xenograft_EC_24h_1_Set1" = "seppack?",
                "Xenograft_EBC_24h_3_Set1"  = "seppack?",
                "Xenograft_ctrl_5d_3_Set1"  = "seppack?",
                "Xenograft_E_24h_1_Set1"  = "seppack?",
                "Xenograft_E_24h_2_Set1"  = "seppack?",
                "Xenograft_EBC_24h_2_Set1"  = "seppack?",
                "Xenograft_EBC_24h_4_Set1"  = "seppack?",
                "Xenograft_E_24h_5_Set1"  = "seppack?",
                "Xenograft_E_24h_3_Set1"  = "seppack?",
                "Xenograft_ctrl_5d_5_Set1"  = "seppack?",
               "Xenograft_EC_24h_4_Set1"  = "seppack?",
                "Xenograft_EC_24h_3_Set1" = "seppack?",
                "Xenograft_EBC_24h_1_Set1"  = "seppack?",
                "Xenograft_EBC_5d_4_Set2"   = "seppack?",
                "Xenograft_ctrl_5d_7_Set2"    = "seppack?",
                "Xenograft_EC_5d_3_Set2"    = "seppack?",
                "Xenograft_ctrl_5d_5_Set2"    = "seppack?",
                "Xenograft_E_5d_2_Set2"   = "seppack?",
                "Xenograft_EBC_5d_3_Set2"   = "seppack?",
                "Xenograft_E_5d_3_Set2"   = "seppack?",
                "Xenograft_EBC_5d_2_Set2"   = "seppack?",
                "Xenograft_ctrl_5d_3_Set2"    = "seppack?",
                "Xenograft_E_5d_4_Set2"   = "seppack?",
                "Xenograft_EC_5d_4_Set2"    = "seppack?",
                "Xenograft_ctrl_5d_1_Set2"   = "seppack?",
                "Xenograft_E_5d_5_Set2"   = "seppack?",
                "Xenograft_EC_5d_2_Set2"    = "seppack?",
                "Xenograft_EC_5d_1_Set2"    = "seppack?",
                "Xenograft_EBC_5d_1_Set2"   = "seppack?",
                "Xenograft_EC_5d_5_Set2"    = "seppack?",
                "Xenograft_EBC_5d_5_Set2" = "seppack?"
)
```
...
colnames(pY_withNA)[c(5:22)] <- channels_Set1[colnames(pY_withNA)[c(5:22)]]
#colnames(pY_withNA)[c(24:34,36:41)] <- channels_Set2[colnames(pY_withNA)[c(24:34,36:41)]]
colnames(pY_withNA)[c(24:41)] <- channels_Set2[colnames(pY_withNA)[c(24:41)]]
...
colnames(pST_withNA)[c(5:22)] <- channels_Set1[colnames(pST_withNA)[c(5:22)]]
#colnames(pST_withNA)[c(24:34,36:41)] <- channels_Set2[colnames(pST_withNA)[c(24:34,36:41)]]
colnames(pST_withNA)[c(24:41)] <- channels_Set2[colnames(pST_withNA)[c(24:41)]]
