...
som.pept.pY <- Train_SOM(phos_mat= t(pY_mat_normtomedian), try.k = 2:40)
...
Plot_Profiles_SOM_clusters_day(som.model = som.model.pept.pY,
                           clusters = cluster.tries.pept.pY$som.cluster.k.15,
                           phos_mat = pY_mat_normtomedian)

Plot_Profiles_SOM_clusters_day_sorted_by_day(som.model = som.model.pept.pY,
                           clusters = cluster.tries.pept.pY$som.cluster.k.15,
                           phos_mat = pY_mat_normtomedian)
```
