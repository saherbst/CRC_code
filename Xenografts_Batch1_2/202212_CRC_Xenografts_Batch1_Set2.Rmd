---
title: "CRC - Xenografts batch1 Set2"
...
```{r, warning=FALSE}
set.seed(2022)
file_path_pY <- "../Data/Mass_Spec/SH_20230202_CRC_Xenografts_Batch1_Set2_TMTPro_AC56_AA_pY_PSMs.txt"
#file_path_pST <- "Data/Mass_Spec/SH_20221006_Sepsis_MACSlowvolume_TMT10_AC39_AA_pST_PSMs.txt"
file_path_sup <- "../Data/Mass_Spec/SH_20230202_CRC_Xenografts_Batch1_Set2_TMTpro_pre10+AC53_HR1_sup_PSMs.txt"
```
...
### Annotate
```{r}
name_l = list( "126" = "Xenograft_EBC_5d_4",
               "127N" = "Xenograft_ctrl_5d_7",
               "127C" = "Xenograft_EC_5d_3",
               "128N"	= "Xenograft_ctrl_5d_5",
               "128C"	 = "Xenograft_E_5d_2",
               "129N"	= "Xenograft_EBC_5d_3",
               "129C"	= "Xenograft_E_5d_3",
               "130N"	= "Xenograft_EBC_5d_2",
               "130C"	= "Xenograft_ctrl_5d_3",
               "131N"	= "Xenograft_E_5d_4",
               "131C"	= "Xenograft_EC_5d_4",
               "132N"	= "Xenograft_ctrl_5d_1",
               "132C"	= "Xenograft_E_5d_5",
               "133N"	= "Xenograft_EC_5d_2",
               "133C"	= "Xenograft_EC_5d_1",
               "134N"= "Xenograft_EBC_5d_1",
               "134C"	= "Xenograft_EC_5d_5",
               "135N"	= "Xenograft_EBC_5d_5"
)

prep_l = list("Xenograft_EBC_5d_4"  = "prep2", 
     "Xenograft_ctrl_5d_7"  = "prep2", 
     "Xenograft_EC_5d_3"  = "prep2", 
     "Xenograft_ctrl_5d_5"  = "prep2", 
     "Xenograft_E_5d_2" = "prep2", 
     "Xenograft_EBC_5d_3" = "prep2", 
     "Xenograft_E_5d_3" = "prep2", 
     "Xenograft_EBC_5d_2" = "prep2", 
     "Xenograft_ctrl_5d_3"  = "prep1", 
     "Xenograft_E_5d_4" = "prep2", 
     "Xenograft_EC_5d_4"  = "prep2", 
     "Xenograft_ctrl_5d_1"  = "prep1", 
     "Xenograft_E_5d_5" = "prep2", 
     "Xenograft_EC_5d_2"  = "prep2", 
     "Xenograft_EC_5d_1"  = "prep2", 
    "Xenograft_EBC_5d_1"  = "prep2", 
     "Xenograft_EC_5d_5"  = "prep2", 
     "Xenograft_EBC_5d_5" = "prep2" 
)

seppack_l = list("Xenograft_EBC_5d_4"  =  "seppack?" ,
                 "Xenograft_ctrl_5d_7"  =  "seppack?" ,
                 "Xenograft_EC_5d_3"  =  "seppack?" ,
                 "Xenograft_ctrl_5d_5"  =  "seppack?" ,
                 "Xenograft_E_5d_2" =  "seppack?" ,
                 "Xenograft_EBC_5d_3" =  "seppack?" ,
                 "Xenograft_E_5d_3" =  "seppack?" ,
                 "Xenograft_EBC_5d_2" =  "seppack?" ,
                 "Xenograft_ctrl_5d_3"  =  "seppack?" ,
                 "Xenograft_E_5d_4" =  "seppack?" ,
                 "Xenograft_EC_5d_4"  =  "seppack?" ,
                 "Xenograft_ctrl_5d_1"  =  "seppack?" ,
                 "Xenograft_E_5d_5" =  "seppack?" ,
                 "Xenograft_EC_5d_2"  =  "seppack?" ,
                 "Xenograft_EC_5d_1"  =  "seppack?" ,
                 "Xenograft_EBC_5d_1"  =  "seppack?" ,
                 "Xenograft_EC_5d_5"  =  "seppack?" ,
                 "Xenograft_EBC_5d_5" = "seppack?"
) 
