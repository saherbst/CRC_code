...
```{r}
data_diff_Set1_vs_Set3_pY <- test_diff(pY_se_runs_comp, type = "manual", 
                              test = c("Set1_vs_Set3"))
dep_Set1_vs_Set3_pY <- add_rejections_SH(data_diff_Set1_vs_Set3_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_Set1_vs_Set3_pY, contrast = "Set1_vs_Set3", label_size = 2, add_names = TRUE, additional_title = "pY"))
```

```{r, fig.width=10, fig.height=10}
Return_DEP_Hits_Plots(data = pY_noNA, dep_Set1_vs_Set3_pY, comparison = "Set1_vs_Set3_diff")

#data_results <- get_df_long(dep)
```

```{r}
data_diff_Set2_vs_Set3_pY <- test_diff(pY_se_runs_comp, type = "manual", 
                              test = c("Set2_vs_Set3"))
dep_Set2_vs_Set3_pY <- add_rejections_SH(data_diff_Set2_vs_Set3_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_Set2_vs_Set3_pY, contrast = "Set2_vs_Set3", label_size = 2, add_names = TRUE, additional_title = "pY"))
```

```{r, fig.width=10, fig.height=10}
Return_DEP_Hits_Plots(data = pY_noNA, dep_Set2_vs_Set3_pY, comparison = "Set2_vs_Set3_diff")
...
```{r}
data_diff_Set1_vs_Set3_pY <- test_diff(pY_se_24h_runs_comp, type = "manual", 
                              test = c("Set1_vs_Set3"))
dep_Set1_vs_Set3_pY <- add_rejections_SH(data_diff_Set1_vs_Set3_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_Set1_vs_Set3_pY, contrast = "Set1_vs_Set3", label_size = 2, add_names = TRUE, additional_title = "pY"))
```
...
```{r}
data_diff_Set2_vs_Set3_pY <- test_diff(pY_se_24h_runs_comp, type = "manual", 
                              test = c("Set2_vs_Set3"))
dep_Set2_vs_Set3_pY <- add_rejections_SH(data_diff_Set2_vs_Set3_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_Set2_vs_Set3_pY, contrast = "Set2_vs_Set3", label_size = 2, add_names = TRUE, additional_title = "pY"))
```
...
#### Each condition vs ctrl Prep1
```{r, eval=TRUE}
pY_se_24h_prep1 <- pY_se_24h_preps
pY_se_24h_prep1 <- pY_se_24h_prep1[,pY_se_24h_prep1$prep == "prep1" ]
data_diff_ctrl_vs_E_pY <- test_diff(pY_se_24h_prep1, type="manual", test = "E_vs_ctrl")
dep_ctrl_vs_E_pY <- add_rejections_SH(data_diff_ctrl_vs_E_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_ctrl_vs_E_pY, contrast = "E_vs_ctrl", 
                label_size = 2, add_names = TRUE,
                additional_title = "pY"))
...
```{r, fig.width=10, fig.height=10}
paste0("log2FC_Xenograft_", colnames(pY_se_24h_prep1) )
...
```{r}
data_diff_EC_vs_ctrl_pY <- test_diff(pY_se_24h_prep1, type="manual", test = "EC_vs_ctrl")
dep_EC_vs_ctrl_pY <- add_rejections_SH(data_diff_EC_vs_ctrl_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_EC_vs_ctrl_pY, contrast = "EC_vs_ctrl", 
                label_size = 2, add_names = TRUE,
                additional_title = "pY"))
...
```{r}
data_diff_EBC_vs_ctrl_pY <- test_diff(pY_se_24h_prep1, type="manual", test = "EBC_vs_ctrl")
dep_EBC_vs_ctrl_pY <- add_rejections_SH(data_diff_EBC_vs_ctrl_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_EBC_vs_ctrl_pY, contrast = "EBC_vs_ctrl", 
                label_size = 2, add_names = TRUE,
                additional_title = "pY"))
...
#### Each condition vs ctrl Prep2
```{r, eval=TRUE}
pY_se_24h_prep2 <- pY_se_24h_preps
pY_se_24h_prep2 <- pY_se_24h_prep2[,pY_se_24h_prep2$prep == "prep2" ]
data_diff_ctrl_vs_E_pY <- test_diff(pY_se_24h_prep2, type="manual", test = "E_vs_ctrl")
dep_ctrl_vs_E_pY <- add_rejections_SH(data_diff_ctrl_vs_E_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_ctrl_vs_E_pY, contrast = "E_vs_ctrl", 
                label_size = 2, add_names = TRUE,
                additional_title = "pY"))
...
```{r, fig.width=10, fig.height=10}
paste0("log2FC_Xenograft_", colnames(pY_se_24h_prep2) )
...
```{r}
data_diff_EC_vs_ctrl_pY <- test_diff(pY_se_24h_prep2, type="manual", test = "EC_vs_ctrl")
dep_EC_vs_ctrl_pY <- add_rejections_SH(data_diff_EC_vs_ctrl_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_EC_vs_ctrl_pY, contrast = "EC_vs_ctrl", 
                label_size = 2, add_names = TRUE,
                additional_title = "pY"))
...
```{r}
data_diff_EBC_vs_ctrl_pY <- test_diff(pY_se_24h_prep2, type="manual", test = "EBC_vs_ctrl")
dep_EBC_vs_ctrl_pY <- add_rejections_SH(data_diff_EBC_vs_ctrl_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_EBC_vs_ctrl_pY, contrast = "EBC_vs_ctrl", 
                label_size = 2, add_names = TRUE,
                additional_title = "pY"))
...
```{r}
data_diff_Set1_vs_Set3_pY <- test_diff(pY_se_5d_runs_comp, type = "manual", 
                              test = c("Set1_vs_Set3"))
dep_Set1_vs_Set3_pY <- add_rejections_SH(data_diff_Set1_vs_Set3_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_Set1_vs_Set3_pY, contrast = "Set1_vs_Set3", label_size = 2, add_names = TRUE, additional_title = "pY"))
```
...
```{r}
data_diff_Set2_vs_Set3_pY <- test_diff(pY_se_5d_runs_comp, type = "manual", 
                              test = c("Set2_vs_Set3"))
dep_Set2_vs_Set3_pY <- add_rejections_SH(data_diff_Set2_vs_Set3_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_Set2_vs_Set3_pY, contrast = "Set2_vs_Set3", label_size = 2, add_names = TRUE, additional_title = "pY"))
```
...
#### Each condition vs ctrl Prep1
```{r, eval=TRUE}
pY_se_5d_prep1 <- pY_se_5d_preps
pY_se_5d_prep1 <- pY_se_5d_prep1[,pY_se_5d_prep1$prep == "prep1" ]
data_diff_ctrl_vs_E_pY <- test_diff(pY_se_5d_prep1, type="manual", test = "E_vs_ctrl")
dep_ctrl_vs_E_pY <- add_rejections_SH(data_diff_ctrl_vs_E_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_ctrl_vs_E_pY, contrast = "E_vs_ctrl", 
                label_size = 2, add_names = TRUE,
                additional_title = "pY"))
...
```{r, fig.width=10, fig.height=10}
paste0("log2FC_Xenograft_", colnames(pY_se_5d_prep1) )
...
```{r}
data_diff_EC_vs_ctrl_pY <- test_diff(pY_se_5d_prep1, type="manual", test = "EC_vs_ctrl")
dep_EC_vs_ctrl_pY <- add_rejections_SH(data_diff_EC_vs_ctrl_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_EC_vs_ctrl_pY, contrast = "EC_vs_ctrl", 
                label_size = 2, add_names = TRUE,
                additional_title = "pY"))
...
```{r}
data_diff_EBC_vs_ctrl_pY <- test_diff(pY_se_5d_prep1, type="manual", test = "EBC_vs_ctrl")
dep_EBC_vs_ctrl_pY <- add_rejections_SH(data_diff_EBC_vs_ctrl_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_EBC_vs_ctrl_pY, contrast = "EBC_vs_ctrl", 
                label_size = 2, add_names = TRUE,
                additional_title = "pY"))
...
#### Each condition vs ctrl Prep2
```{r, eval=TRUE}
pY_se_5d_prep2 <- pY_se_5d_preps
pY_se_5d_prep2 <- pY_se_5d_prep2[,pY_se_5d_prep2$prep == "prep2" ]
data_diff_ctrl_vs_E_pY <- test_diff(pY_se_5d_prep2, type="manual", test = "E_vs_ctrl")
dep_ctrl_vs_E_pY <- add_rejections_SH(data_diff_ctrl_vs_E_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_ctrl_vs_E_pY, contrast = "E_vs_ctrl", 
                label_size = 2, add_names = TRUE,
                additional_title = "pY"))
...
```{r, fig.width=10, fig.height=10}
paste0("log2FC_Xenograft_", colnames(pY_se_5d_prep2) )
...
```{r}
data_diff_EC_vs_ctrl_pY <- test_diff(pY_se_5d_prep2, type="manual", test = "EC_vs_ctrl")
dep_EC_vs_ctrl_pY <- add_rejections_SH(data_diff_EC_vs_ctrl_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_EC_vs_ctrl_pY, contrast = "EC_vs_ctrl", 
                label_size = 2, add_names = TRUE,
                additional_title = "pY"))
...
```{r}
data_diff_EBC_vs_ctrl_pY <- test_diff(pY_se_5d_prep2, type="manual", test = "EBC_vs_ctrl")
dep_EBC_vs_ctrl_pY <- add_rejections_SH(data_diff_EBC_vs_ctrl_pY, alpha = 0.05, lfc = log2(1.2))
GGPlotly_Wrapper_Volcano(plot_volcano_SH(dep_EBC_vs_ctrl_pY, contrast = "EBC_vs_ctrl", 
                label_size = 2, add_names = TRUE,
                additional_title = "pY"))
