---
title: "CRC - Xenografts batch1 Set3"
...
```{r, warning=FALSE}
set.seed(2022)
file_path_pY <- "../Data/Mass_Spec/SH_20221209_CRC_Xenografts_Batch1_Set3_TMTPro_AC52_AA_pY_PSMs.txt"
#file_path_pST <- "Data/Mass_Spec/SH_20221006_Sepsis_MACSlowvolume_TMT10_AC39_AA_pST_PSMs.txt"
file_path_sup <- "../Data/Mass_Spec/SH_20221209_CRC_Xenografts_Batch1_Set3_TMTpro_pre8+AC47_HR1-50min_sup_PSMs.txt"
```
...
### Annotate
```{r}
name_l = list( "126" =  "Xenograft_EC_5d_4",
               "127N" = "Xenograft_EBC_5d_4",
               "127C" = "Xenograft_ctrl_5d_5",
               "128N"	= "Xenograft_EBC_5d_5",
               "128C"	= "Xenograft_E_24h_5",
               "129N"	= "Xenograft_EC_5d_5",
               "129C"	= "Xenograft_EBC_24h_4",
               "130N"	= "Xenograft_ctrl_5d_7",
               "130C"	= "Xenograft_ctrl_5d_4",
               "131N"	= "Xenograft_EC_24h_4",
               "131C"	= "Xenograft_E_24h_1",
               "132N"	= "Xenograft_E_5d_5",
               "132C"	= "Xenograft_ctrl_5d_1",
               "133N"	= "Xenograft_EC_24h_5",
               "133C"	= "Xenograft_EBC_24h_5",
               "134N" = "Xenograft_ctrl_5d_3"
)
  
prep_l = list( "Xenograft_EC_5d_4" = "prep1",
               "Xenograft_EBC_5d_4" = "prep2",
               "Xenograft_ctrl_5d_5" = "prep1",
               "Xenograft_EBC_5d_5" = "prep1",
               "Xenograft_E_24h_5" = "prep2",
               "Xenograft_EC_5d_5" = "prep2",
               "Xenograft_EBC_24h_4" = "prep2",
               "Xenograft_ctrl_5d_7" = "prep1",
               "Xenograft_ctrl_5d_4" = "prep2",
               "Xenograft_EC_24h_4" = "prep2",
               "Xenograft_E_24h_1" = "prep1",
               "Xenograft_E_5d_5" = "prep1",
               "Xenograft_ctrl_5d_1" = "prep1",
               "Xenograft_EC_24h_5" = "prep1",
               "Xenograft_EBC_24h_5" = "prep2",
               "Xenograft_ctrl_5d_3" = "prep1"
)

seppack_l = list( "Xenograft_EC_5d_4" = "seppack2",
               "Xenograft_EBC_5d_4" = "seppack1",
               "Xenograft_ctrl_5d_5" = "seppack2",
               "Xenograft_EBC_5d_5" = "seppack2",
               "Xenograft_E_24h_5" = "seppack2",
               "Xenograft_EC_5d_5" = "seppack2",
               "Xenograft_EBC_24h_4" = "seppack2",
               "Xenograft_ctrl_5d_7" = "seppack2",
               "Xenograft_ctrl_5d_4" = "seppack1",
               "Xenograft_EC_24h_4" = "seppack2",
               "Xenograft_E_24h_1" = "seppack1",
               "Xenograft_E_5d_5" = "seppack2",
               "Xenograft_ctrl_5d_1" = "seppack1",
               "Xenograft_EC_24h_5" = "seppack2",
               "Xenograft_EBC_24h_5" = "seppack2",
