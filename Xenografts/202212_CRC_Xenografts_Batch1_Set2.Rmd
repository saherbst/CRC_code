...
```{r, warning=FALSE}
set.seed(2022)
file_path_pY <- "../Data/Mass_Spec/SH_2022120_CRC_Xenografts_Batch1_Set2_TMTPro_AC35_AA_pY3_PSMs.txt"
#file_path_pST <- "Data/Mass_Spec/SH_20221006_Sepsis_MACSlowvolume_TMT10_AC39_AA_pST_PSMs.txt"
file_path_sup <- "../Data/Mass_Spec/SH_20221208_CRC_Xenografts_Batch1_Set2_TMTpro_pre7+AC44_HR1-50min_sup_PSMs.txt"
```
...
### Annotate
```{r}
name_l = list( "126" = "Xenograft_E_24h_1",
               "127N" = "Xenograft_EBC_5d_2",
               "127C" = "Xenograft_EBC_5d_1",
               "128N"	= "Xenograft_EBC_5d_3",
               "128C"	 = "Xenograft_ctrl_5d_3",
               "129N"	= "Xenograft_EC_5d_1",
               "129C"	= "Xenograft_EC_5d_3",
               "130N"	= "Xenograft_E_5d_1",
               "130C"	= "Xenograft_ctrl_5d_1",
               "131N"	= "Xenograft_E_5d_4",
               "131C"	= "Xenograft_ctrl_5d_4",
               "132N"	= "Xenograft_E_5d_3",
               "132C"	= "Xenograft_ctrl_5d_6",
               "133N"	= "Xenograft_ctrl_5d_2",
               "133C"	= "Xenograft_EC_5d_2",
               "134N"= "Xenograft_E_5d_2"
)

  
prep_l = list("Xenograft_E_24h_1" = "prep1",
               "Xenograft_EBC_5d_2" = "prep2",
               "Xenograft_EBC_5d_1" = "prep1",
               "Xenograft_EBC_5d_3" = "prep1",
               "Xenograft_ctrl_5d_3" = "prep1",
               "Xenograft_EC_5d_1" = "prep2",
               "Xenograft_EC_5d_3" = "prep2",
               "Xenograft_E_5d_1" = "prep1",
               "Xenograft_ctrl_5d_1" = "prep1",
               "Xenograft_E_5d_4" = "prep2",
               "Xenograft_ctrl_5d_4" = "prep2",
               "Xenograft_E_5d_3" = "prep1",
               "Xenograft_ctrl_5d_6" = "prep2",
               "Xenograft_ctrl_5d_2" = "prep2",
               "Xenograft_EC_5d_2" = "prep1",
               "Xenograft_E_5d_2" = "prep2"
)

seppack_l = list("Xenograft_E_24h_1" = "seppack1",
               "Xenograft_EBC_5d_2" = "seppack1",
               "Xenograft_EBC_5d_1" = "seppack1",
               "Xenograft_EBC_5d_3" = "seppack1",
               "Xenograft_ctrl_5d_3" = "seppack1",
               "Xenograft_EC_5d_1" = "seppack1",
               "Xenograft_EC_5d_3" = "seppack1",
               "Xenograft_E_5d_1" = "seppack1",
               "Xenograft_ctrl_5d_1" = "seppack1",
               "Xenograft_E_5d_4" = "seppack2",
               "Xenograft_ctrl_5d_4" = "seppack1",
               "Xenograft_E_5d_3" = "seppack1",
               "Xenograft_ctrl_5d_6" = "seppack2",
               "Xenograft_ctrl_5d_2" = "seppack1",
               "Xenograft_EC_5d_2" = "seppack1",
               "Xenograft_E_5d_2" = "seppack1"
)
