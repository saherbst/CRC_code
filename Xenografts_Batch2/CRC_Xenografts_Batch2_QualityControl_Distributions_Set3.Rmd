---
title: "Quality control - Distributions - CRC Batch 2 Set 3"
...
## Nr. phospho sites
```{r}
print( paste( nrow(pY_Set3_form) , "pY peptides passed the filtering procedure for this Set. These peptides were detected from", length(unique(pY_Set3_form$HGNC_Symbol) ), "proteins." ))
print( paste( nrow(pST_Set3_form) , "pY peptides passed the filtering procedure for this Set. These peptides were detected from", length(unique(pST_Set3_form$HGNC_Symbol) ), "proteins." ))
```
