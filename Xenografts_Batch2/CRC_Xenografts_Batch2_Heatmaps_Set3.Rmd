---
title: "Heatmaps - CRC Batch 2 Set 3"
...
t(pY_mat_Set3_normtomedian) %>% 
  plot_centered_heatmaply_around_nochange(
    labCol = sub("log2FC_", "", rownames(pY_mat_Set3_normtomedian)),
