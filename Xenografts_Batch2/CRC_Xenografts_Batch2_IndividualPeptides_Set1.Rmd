---
title: "Plotting individual peptides - CRC Batch 2 Set 1"
...
plot_boxplot_phos( dat= pY_Set1_form, prot = "SRC", add_title = "pY" )
...
## BRAF
```{r}
plot_barplot_phos( dat= pY_Set1_form, prot = "BRAF", add_title = "pY" )
plot_barplot_phos( dat= pST_Set1_form, prot = "BRAF", add_title = "pST" )
plot_boxplot_phos( dat= pST_Set1_form, prot = "BRAF", add_title = "pST" )

plot_barplot_phos( dat= pY_Set1_form, prot = "RAF1", add_title = "pY" )
plot_barplot_phos( dat= pST_Set1_form, prot = "RAF1", add_title = "pST" )
```
