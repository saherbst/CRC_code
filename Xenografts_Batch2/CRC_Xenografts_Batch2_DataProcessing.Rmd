...
file_path_pY_Set2 <- "../Data/Mass_Spec/SH_20231010_CRC_Xenografts_Batch2_Set2rep3_TMTPro_RA3umAC01_AA_pY_PSMs.txt"
...
file_path_sup_Set2pY <- "../Data/Mass_Spec/SH_20231010_CRC_Xenografts_Batch2_Set2rep3_TMTpro_newpre+AC136_HR1_sup_PSMs.txt"
```
...
pY_Set2 <- Filter_And_Average_PSMs(file_path_phos = file_path_pY_Set2,  
                              file_path_sup = file_path_sup_Set2pY,
                              return_data = "phos", 
                              NA_replace = FALSE, NA_peptide_cutoff = 0,
                              ion_score_filter = 20, 
                              NA_cutoff_channel = 0.4,
...
colData_pY_Set2 <- 
  str_split( 
    #gsub("log2FC_Xenograft_", "", 
         colnames(assay_data_pY_Set2 #) 
                  ), pattern = "_", simplify = TRUE ) %>%
  as.data.frame()
rownames(colData_pY_Set2) <- #gsub("log2FC_Xenograft_", "", 
                                  colnames(assay_data_pY_Set2) #)
colnames(colData_pY_Set2) <- c( "log2FC", "Xenograft", "condition", "day", "replicate", "set" )
colData_pY_Set2$label <- #gsub("log2FC_Xenograft_", "", 
                              colnames(assay_data_pY_Set2) #)
colData_pY_Set2$ID <- #gsub("log2FC_Xenograft_", "", 
                           colnames(assay_data_pY_Set2) #)
