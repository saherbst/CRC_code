---
title: "Quality control - Distributions - CRC Batch 2 Set 2"
...
## Nr. phospho sites
```{r}
print( paste( nrow(pY_Set2_form) , "pY peptides passed the filtering procedure for this Set. These peptides were detected from", length(unique(pY_Set2_form$HGNC_Symbol) ), "proteins." ))
print( paste( nrow(pST_Set2_form) , "pST peptides passed the filtering procedure for this Set. These peptides were detected from", length(unique(pST_Set2_form$HGNC_Symbol) ), "proteins." ))
```
