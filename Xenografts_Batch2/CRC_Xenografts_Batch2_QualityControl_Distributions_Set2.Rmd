...
print( paste( nrow(pST_Set2_form) , "pY peptides passed the filtering procedure for this Set. These peptides were detected from", length(unique(pST_Set2_form$HGNC_Symbol) ), "proteins." ))
```
